...
<img src="https://badgen.net/bundlephobia/min/ngx-angular-responsive-carousel" />
...
```
  npm i ngx-angular-responsive-carousel
```
Import module:
```ts
  import {IvyCarouselModule} from 'ngx-angular-responsive-carousel';
